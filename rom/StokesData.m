classdef StokesData < handle
    ...
    properties
        ...
        input_bitmap    %bitmap of microstr.; true is pore, false is solid phase onto regular mesh
    ...
    methods
        ...
        function setPathName(self)
            if isempty(self.pathname)
                if(strcmp((java.net.InetAddress.getLocalHost.getHostName), 'workstation1-room0436') || ...
                        strcmp((java.net.InetAddress.getLocalHost.getHostName), 'constantin-ThinkPad-T430s'))
                self.pathname = strcat('/home/constantin/cluster/python/data/stokesEquation/');
                else
                    %on cluster
                ...
                if strcmp(self.coordDist, 'GP')
                    self.pathname = char(strcat(self.pathname, 'meshSize=', num2str(self.meshSize),...
                        '/nonOverlappingDisks/margins=',num2str(self.margins(1)), '_',num2str(self.margins(2)), '_', ...
                        num2str(self.margins(3)), '_', num2str(self.margins(4)), '/N~', self.numberDist, '/mu=',...
                        sprintf('%.1f', self.numberParams(1)),'/sigma=',sprintf('%.1f', self.numberParams(2)), '/x~',...
                        self.coordDist, '/cov=', self.coordDist_cov, '/l=', self.densityLengthScale, '/sig_scale=',...
